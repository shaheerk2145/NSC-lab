...
#         result = (result << 1) | bit
#     return result 
# def rotateleft(key ,bits):
#     return ((key << 1) & ((1 << bits ) -1 )) | (key >> (bits - 1 ))

# def rotateright(key ,bits):
#     return ((key & 1 ) << (bits - 1 )) | (key >> 1)

# def sBoxFun(number ,func):
...
#     expansionFunc = [32, 1, 2, 3, 4, 5, 4, 5,
#          6, 7, 8, 9, 8, 9, 10, 11,
...
#     pc2Perm = [14 ,17 ,11 ,24 , 1,5,3,28,15,6,21,10,
...
#     if invertSch :
#         for i in range (16):
#             key = rotateleft(key , 56)
#     for it in range(16):
#         if not invertSch:
#             key = rotateleft(key,56)
#         else:
#             key = rotateright(key , 56)
#         roundkey= permutate(key , pc2Perm ,56)
        
#         expansion = permutate(R , expansionFunc,32)
...
def hex2bin(s):
	mp = {'0': "0000",'1': "0001",'2': "0010",'3': "0011",'4': "0100",'5': "0101",'6': "0110",'7': "0111",'8': "1000",'9': "1001",
...
def bin2hex(s):
	mp = {"0000": '0',"0001": '1',"0010": '2',"0011": '3',"0100": '4',"0101": '5',"0110": '6',"0111": '7',"1000": '8',
